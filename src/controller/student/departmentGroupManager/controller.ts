...
export const changeStudentStatusController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const createStudentController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const editStudentController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const getStudentDetailController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const getStudentListController = async ({ req, res, next }: TControllerProps) => {
  try{
