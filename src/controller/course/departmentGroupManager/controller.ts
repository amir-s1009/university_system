...
export const cancelCourseController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const createCourseController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const deleteCourseController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const editCourseController = async ({ req, res, next }: TControllerProps) => {
  try{
...
export const getCourseDetailController = async ({ req, res, next }: TControllerProps) => {
  try{
